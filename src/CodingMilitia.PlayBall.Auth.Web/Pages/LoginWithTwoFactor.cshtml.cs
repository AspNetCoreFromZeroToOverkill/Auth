...
namespace CodingMilitia.PlayBall.Auth.Web.Pages
{
    public class LoginWithTwoFactorModel : PageModel
    {
        ...
        private readonly ILogger<LoginWithTwoFactorModel> _logger;

        public LoginWithTwoFactorModel(SignInManager<PlayBallUser> signInManager, ILogger<LoginWithTwoFactorModel> logger)
        {
